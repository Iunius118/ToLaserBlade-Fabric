...
public class FireproofUpgrader implements Upgrader {
    ...
    public UpgradeResult apply(ItemStack base, int baseCost, HolderLookup.Provider provider) {
        ...
        // ItemStack newStack = base.transmuteCopy(ModItems.LB_BRAND_NEW_FP, base.getCount());  // Forge
        ItemStack newStack = base.transmuteCopy(ModItems.LASER_BLADE_FP, base.getCount());  // Fabric
