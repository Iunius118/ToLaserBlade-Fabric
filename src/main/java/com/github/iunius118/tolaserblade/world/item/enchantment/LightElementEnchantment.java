...
public class LightElementEnchantment  {
    ...
    public static Enchantment get(HolderGetter<Item> itemHolderGetter, HolderGetter<Enchantment> enchantmentHolderGetter, HolderGetter<EntityType<?>> entityTypeHolderGetter) {
        return Enchantment
                .enchantment(
