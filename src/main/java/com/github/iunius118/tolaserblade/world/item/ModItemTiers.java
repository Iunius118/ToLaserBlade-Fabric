...
public class ModItemTiers {
    ...
    private static final Supplier<Float> LB_SPEED = () -> 12.0F;
    ...
    public record ModItemTier(TagKey<Block> incorrectBlocksForDrops, int uses, Supplier<Float> speed, float damage, int enchantmentValue, Supplier<Ingredient> repairIngredient)
            implements Tier {
        @Override
        public int getUses() {
            return uses;
