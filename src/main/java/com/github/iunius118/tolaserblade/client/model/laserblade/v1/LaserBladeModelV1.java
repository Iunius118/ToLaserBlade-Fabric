    ...
    public static class ModelObject {
        ...
        private void initRenderFunctions(JsonModelV1.JsonModelObject object) {
            ...
            switch (type) {
                ...
                case "add" -> {
                    fnGetRenderType = part.equals("blade_in") ? FunctionsV1.GET_INNER_ADD_RENDERER : FunctionsV1.GET_OUTER_ADD_RENDERER;
                    fnGetLightColor = FunctionsV1.GET_FULL_LIGHT;
                }
                case "flat" -> {
            ...
            switch (part) {
                ...
                case "blade_in" -> {
                    fnGetPartColor = type.equals("add") ? FunctionsV1.GET_INNER_ADD_COLOR : FunctionsV1.GET_INNER_DEFAULT_COLOR;
                }
                case "blade_out" -> {
                    fnGetPartColor = type.equals("add") ? FunctionsV1.GET_OUTER_ADD_COLOR : FunctionsV1.GET_OUTER_DEFAULT_COLOR;
                }
